...
function setupNutritionPopup(page1Data) {
    ...
    modal.setAttribute("aria-labelledby", "bbnNutritionTitle");
    modal.hidden = true;
    ...
    window.showNutritionPopup = function () {
        const nutritionModal = document.getElementById("bbnNutritionModal");

        if (nutritionModal) {
            nutritionModal.hidden = false;
